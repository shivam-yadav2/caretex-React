    ...
    return (
        <div className="sticky top-30 p-6 z-0">
    ...
    return (
      <>
        ...
        <div className="flex flex-col md:flex-row gap-6 p-4 bg-white">
          <div
            className={`fixed inset-0 bg-[#eae7e7] bg-opacity-50 z-0 transform ${
              isSidebarOpen ? "translate-x-0" : "-translate-x-full"
            } md:relative md:translate-x-0 md:w-1/4 p-4 transition-transform`}
          >
            <SidebarFilter
